...
int counter = 0; // global variabel så den kan användas både i och utanför funktioner. 
...
// int first; int last;
   ...
   // thread my_thread(seriellt, first, last); // skapar en tråd som kör programmet. Dock körs allt endast på 1 tråd atm. 
    //cin >> last;
   // seriellt(first, last);

    //my_thread.join(); // kanske kan göra en for loop för att dela upp siffrorna mellan olika trådar. 
    */
